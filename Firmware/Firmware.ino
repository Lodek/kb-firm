...
void custom_mod_handler()
{
  ...
  else
  {
    ...
    if(matrix_status[selector][modvar]==0 && counter<30)
    {
      ++counter;
      map_use=0;
    }
    else if(matrix_status[selector][modvar]==1 && counter<30 && counter!=0)
    {
      toggle=1;
      counter==0;
